      ...
      <div className="flex w-[100vw]">
        <div className="w-[50vw] h-[85vh] ">
          <div className="text-[85px] ml-5 mt-12 mb-12 leading-[1.2]">
            ...
            <p>PRETENTIOUS</p>
            <p className="flex">
              <div className="bg-[url('D:\Octanet\landing-page\Components\brunnetteM.png')] relative border-solid border-4 border-black  relative rounded-full bg-cover h-[100px] w-[100px]">
              </div>
